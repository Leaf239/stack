...
function setRandomGradientBackground() {
    ...
    const newBackground = `linear-gradient(to bottom right, ${start}, ${end})`;

    let overlay = document.getElementById('bg-transition');
    if (!overlay) {
        overlay = document.createElement('div');
        overlay.id = 'bg-transition';
...
class Block {
    constructor(block) {
        ...
        // set direction
        this.speed = -0.15 - (this.index * 0.0075);
        if (this.speed < -4)
            this.speed = -4;
